...
class ModifierNomUtil extends StatefulWidget {
  final String utilisateur;
  final int identite;

  const ModifierNomUtil({super.key, required this.utilisateur, required this.identite});

  @override
  State<ModifierNomUtil> createState() => _ModifierNomUtilState();
}

class _ModifierNomUtilState extends State<ModifierNomUtil> {
